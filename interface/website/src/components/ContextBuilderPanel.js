...
export function ContextBuilderPanel({
  ...
  return React.createElement(
    ...
    React.createElement(
      BeamFrame,
      { active: isPreparing || isLoading, tone: "ocean", className: "content-panel context-builder-panel" },
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement("h2", { className: "content-panel-title" }, "Prepare Codex Prompt"),
          React.createElement(
            "p",
            { className: "content-panel-note" },
      ...
      React.createElement(
        ...
        React.createElement("span", { className: "content-panel-pill" }, selectedProvider || "No provider"),
        React.createElement("span", { className: "content-panel-pill" }, `${matchedSessions.length} sessions`),
        React.createElement("span", { className: "content-panel-pill" }, includeWorkspaceScan ? "Repo scan" : "Prompt only"),
        React.createElement("span", { className: "content-panel-rail-copy" }, statusMessage || "Assemble context, choose sessions, and preview the exact prompt before you hand off.")
      ),
      React.createElement(
        "div",
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            matchedSessions.length
              ...
              : React.createElement("div", { className: "content-panel-empty" }, "No sessions available for this provider.")
          )
        ),
        React.createElement(
          MetalSurface,
