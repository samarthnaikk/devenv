...
const healthPayload = {
  ...
  tool_readiness: {
    list_directory: { ready: true, detail: "Directory inspection is available for mapping folders and top-level workspace structure." },
    locate_files: { ready: true, detail: "Filename and path lookup is available for finding likely files before deeper inspection." },
    read_file: { ready: true, detail: "Direct file reading is available for opening exact files and reviewing source content." },
    search_text: { ready: true, detail: "Repo-wide text search is available for finding strings, selectors, and usage sites." },
    inspect_symbols: { ready: true, detail: "Symbol inspection is available for definitions, exports, and structural code lookup." },
    track_symbol: { ready: true, detail: "Symbol tracing is available for following a definition through the codebase." },
    generate_prompt: { ready: true },
    generate_pdf: { ready: true },
    web_search: { ready: true },
    knowledge_search: { ready: true, detail: "Reference search is available for repos, docs, videos, and discussion threads." },
  },
  mcp_server: {},
